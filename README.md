...
Once you finish your codes, and pass all the tests. You don't have to worry about code formatting, git action will automatically format the code for you when you create a request to develop branch or master branch. Then make sure all you changed have been committed locally, and make sure the commit messages are readable (meet the rules).
