...
TEST_F(TestDifferentType, differentTypeCalculation) {
    ...
    addSingleThread(1, doubleMatrix, doubleOutput, 0, 0, doubleMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 0.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    addSingleThread(1, doubleMatrix, intOutput, 0, 0, doubleMatrix.shape());
    intResult = Matrix<int>({3, 3}, 0);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    addSingleThread(1, intMatrix, doubleOutput, 0, 0, intMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 0.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    addSingleThread(1, intMatrix, intOutput, 0, 0, intMatrix.shape());
    intResult = Matrix<int>({3, 3}, 0);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));

    subtractSingleThread(1, doubleMatrix, doubleOutput, 0, 0, doubleMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 2.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    subtractSingleThread(1, doubleMatrix, intOutput, 0, 0, doubleMatrix.shape());
    intResult = Matrix<int>({3, 3}, 2);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    subtractSingleThread(1, intMatrix, doubleOutput, 0, 0, intMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 2.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    subtractSingleThread(1, intMatrix, intOutput, 0, 0, intMatrix.shape());
    intResult = Matrix<int>({3, 3}, 2);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    subtractSingleThread(doubleMatrix, 1, doubleOutput, 0, 0, doubleMatrix.shape());
    doubleResult = Matrix<>({3, 3}, -2.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    subtractSingleThread(doubleMatrix, 1, intOutput, 0, 0, doubleMatrix.shape());
    intResult = Matrix<int>({3, 3}, -2);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    subtractSingleThread(intMatrix, 1, doubleOutput, 0, 0, intMatrix.shape());
    doubleResult = Matrix<>({3, 3}, -2.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    subtractSingleThread(intMatrix, 1, intOutput, 0, 0, intMatrix.shape());
    intResult = Matrix<int>({3, 3}, -2);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));

    multiplySingleThread(-1, doubleMatrix, doubleOutput, 0, 0, doubleMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 1.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    multiplySingleThread(-1, doubleMatrix, intOutput, 0, 0, doubleMatrix.shape());
    intResult = Matrix<int>({3, 3}, 1);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    multiplySingleThread(-1, intMatrix, doubleOutput, 0, 0, intMatrix.shape());
    doubleResult = Matrix<>({3, 3}, 1.);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    multiplySingleThread(-1, intMatrix, intOutput, 0, 0, intMatrix.shape());
    intResult = Matrix<int>({3, 3}, 1);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    ...
    intResult = Matrix<int>({3, 3}, 1);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    divideSingleThread(doubleMatrix, 3, doubleOutput, 0, 0, doubleMatrix.shape());
    doubleResult = Matrix<>({3, 3}, -1. / 3);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    divideSingleThread(doubleMatrix, 3, intOutput, 0, 0, doubleMatrix.shape());
    intResult = Matrix<int>({3, 3}, -1. / 3);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
    divideSingleThread(intMatrix, 3, doubleOutput, 0, 0, intMatrix.shape());
    doubleResult = Matrix<>({3, 3}, -1. / 3);
    ASSERT_TRUE(equalSingleThread(doubleOutput, doubleResult, 0, doubleOutput.size()));
    divideSingleThread(intMatrix, 3, intOutput, 0, 0, intMatrix.shape());
    intResult = Matrix<int>({3, 3}, -1. / 3);
    ASSERT_TRUE(equalSingleThread(intOutput, intResult, 0, intOutput.size()));
}
}  // namespace test
